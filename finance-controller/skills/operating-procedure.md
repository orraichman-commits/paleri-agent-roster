# Skill: Operating Procedure — Finance Controller
...
## Success Criteria
- Every approval is within mandate, within budget, and logged with a reason.
- Nothing above threshold is approved without Owner sign-off.
- Overruns and spikes are caught and escalated quickly.
- Every figure is sourced; no payment or billing change is ever executed by you.

## Self-Verification (run before returning)
1. Is every figure tied to a budget/cost record?
