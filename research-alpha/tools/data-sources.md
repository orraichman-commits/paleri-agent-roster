...
- **External research connectors** — used only when connected and approved. There is no
  supplier-lookup step. Or has his own supplier; LIO quotes it after research finishes.
  ...
  - **AliExpress** (provisional unit cost only) — the cost side of the ≥ 2.5× market-price
    screen. Not a supplier search, not IP clearance, and not permission to sell a branded
    or licensed product.
